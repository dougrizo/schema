...
type CryptoTradePayload struct {
	...
	IsMarketMaker float32 `protobuf:"fixed32,5,opt,name=is_market_maker,json=isMarketMaker,proto3" json:"is_market_maker,omitempty"`
}
...
func (x *CryptoTradePayload) GetIsMarketMaker() float32 {
	if x != nil {
...
var file_crypto_trade_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0d, 0x69, 0x73, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x4d, 0x61, 0x6b, 0x65,
